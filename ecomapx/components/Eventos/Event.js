...
import { View, Text, TouchableOpacity, Modal, Image, StyleSheet, ScrollView, Button, KeyboardAvoidingView} from 'react-native';
...
const Event = ({ route }) => {
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContent}>
            ...
            {/*Aqui hacer la logica de las estrellas*/}

            {/* Vista de puntuación y botón para puntuar */}
            ...
            {/* Modal para seleccionar las estrellas */}
            <Modal
                animationType="slide"
                transparent={true}
